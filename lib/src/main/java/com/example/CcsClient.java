...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyBlQ1dxOsFmDmpq25A3IRB_8k0J5vSnrtA";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyBlQ1dxOsFmDmpq25A3IRB_8k0J5vSnrtA";
    ...
    public static void main(String[] args) {
        final String projectId = "287080179367";
        ...
        final String toRegId ="APA91bHeykWApuGsYRR5C5Fvw9ILrLSmjQ-X0mCQgsGihVgKTZ2gBxlEeNEE0r67kso9u8cSL7k4vKZho00dn5ZpNiq82ECFwEDB4jJ4d1shfUh4xLPUEaf1xPQO_RYgnAi_8swnHdha";
